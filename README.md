...
## Running Migrations
1. Create Migration: Replace --context param with the correct DbContext
```
  dotnet ef migrations add Initial --startup-project Enkata.Web --project Enkata.Infrastructure/ --context AppIdentityDbContext
```

2. Update Database: Replace --context param with  the correct DbContext
```
dotnet ef database update -s Enkata.Web --project Enkata.Infrastructure --context AppIdentityDbContext
```
